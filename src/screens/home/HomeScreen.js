...
export function HomeScreen() {
  ...
  const [proteinLeft, setProteinLeft] = useState(null);
  const [todayPlanTitle, setTodayPlanTitle] = useState(null);
    ...
    <View style={styles.root}>
      ...
      >
        ...
        <View style={[styles.header, { paddingTop: insets.top + spacing.md }]}>
          ...
          <TouchableOpacity
            style={[styles.favBtn]}
            onPress={() => nav.navigate('Exercises', { screen: 'Favorites' })}
        ...
        <View style={styles.heroSection}>
          ...
          <View style={styles.ctaRow}>
            <TouchableOpacity
              ...
              onPress={() => nav.navigate('Exercises', { screen: 'ExerciseList' })}
              accessibilityRole="button"
            ...
            <TouchableOpacity
              ...
              onPress={() => nav.navigate('You', { screen: 'Plan' })}
              accessibilityRole="button"
        ...
        <View style={styles.statsRow}>
          <TouchableOpacity
            ...
            onPress={() => nav.navigate('Fuel', { screen: 'Nutrition' })}
            activeOpacity={0.8}
            accessibilityRole="button"
          ...
          <TouchableOpacity
            style={[styles.statCard, { backgroundColor: 'rgba(255,255,255,0.13)', borderColor: 'rgba(255,255,255,0.2)' }]}
            onPress={() => nav.navigate('You', { screen: 'WorkoutHistory' })}
            activeOpacity={0.8}
            accessibilityRole="button"
        ...
        {inProgress ? (
          <TouchableOpacity
            ...
            onPress={() => nav.navigate('You', { screen: 'ActiveWorkout', params: { sessionId: inProgress.id } })}
            activeOpacity={0.8}
            accessibilityRole="button"
